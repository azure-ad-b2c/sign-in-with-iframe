	...
	public partial class Startup
	{
        ...
        */
		...
		private Task OnRedirectToIdentityProvider(RedirectToIdentityProviderNotification<OpenIdConnectMessage, OpenIdConnectAuthenticationOptions> notification)
		{
            ...
            // Demo: get the domain_hint from the Owing context and set the protocol message parameter
            var domain_hint = notification.OwinContext.Get<string>("domain_hint");
            if (!string.IsNullOrEmpty(domain_hint))
            {
                notification.ProtocolMessage.DomainHint = domain_hint;
            }
